      ...
      <Card sx={{ backgroundColor: 'transparent' }}>
        <CardContent>
          ...
          <Typography className='mbe-4' color='text.secondary'>
            I’m a passionate Full Stack Developer with a strong focus on front-end technologies. With a solid foundation
            in both front and back-end development, I specialize in creating responsive, user-friendly web applications
            that provide a seamless experience across all devices. I have expertise in HTML, CSS, JavaScript, and modern
            frameworks like React (or Angular/Vue, depending on your preference), and I’m equally comfortable working
            with back-end technologies like Node.js and databases to ensure complete functionality.
          </Typography>
